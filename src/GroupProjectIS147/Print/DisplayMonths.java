...
public class DisplayMonths { // for entering user start and end date
    ...
    public void monthsOptions (){
        ...
        System.out.println("\t\t\tJune - Enter 6");
        System.out.println("\t\t\tJuly - Enter 7");
        System.out.println("\t\t\tAugust - Enter 8");
        System.out.println("\t\t\tSeptember - Enter 9");
        System.out.println("\t\t\tOctober - Enter 10");
